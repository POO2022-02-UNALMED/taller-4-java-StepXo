...
public class Taller4 {
    ...
    public static void main(String[] args) {
        ...
        estudiantes1[1] = new Persona(); //falta constructor que cree una persona sin parametros
        ...
        Asignatura asignatura2 = new Asignatura(882,0,Tipo.DISCIPLINAR);
        ...
        asignatura1.cambiarDatos(50); //asignatura de entero tiene sobrecarga
        System.out.println(asignatura1.codigoExterno);
        System.out.println(estudiantes1[1].cedula);
        System.out.println(new Persona("Alejandro").cedula); //falta cedula para persona(String)
    }
}
